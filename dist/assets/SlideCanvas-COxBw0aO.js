const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/images-D8yy03Ac.js","assets/rolldown-runtime-lhHHWwHU.js","assets/db-CmEX-cIt.js","assets/uuid-BG5b7wHq.js","assets/AnnotationLayer-CgtKMBro.js"])))=>i.map(i=>d[i]);
import{t as e}from"./index-CN19KrK4.js";import{t}from"./tts-BXSX4OoT.js";var n=class{constructor(e,t){this.container=e,this.page=t,this.activeImageIndex=0}render(){let e=this.page.textBlock?.sentences||[],t=``;t=e.length>0?e.map((e,t)=>`<span id="sentence-${t}" style="transition: background-color 0.3s;">${e.text}</span>`).join(` `):this.page.textBlock?.rawText||`No text added yet.`;let n=this.page.images.length>0?this.page.images[this.activeImageIndex]:null;this.container.innerHTML=`
