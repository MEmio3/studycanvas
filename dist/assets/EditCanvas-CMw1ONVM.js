const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/images-CTlo234R.js","assets/rolldown-runtime-lhHHWwHU.js","assets/db-DL--i787.js","assets/uuid-Cwm_e2Hs.js"])))=>i.map(i=>d[i]);
import{i as e}from"./pages-xlalZbIM.js";import{t}from"./index-BQ7shzT3.js";import{t as n}from"./AnnotationLayer-CgtKMBro.js";import{r}from"./images-CTlo234R.js";var i=class{constructor(e,t,n,r,i,a){this.page=e,this.imageRecord=t,this.annotation=n,this.annotationIndex=r,this.onSave=i,this.onCancel=a}render(){this.overlay=document.createElement(`div`),this.overlay.className=`modal-overlay flex-center animate-fade-in`,this.overlay.style.position=`fixed`,this.overlay.style.top=`0`,this.overlay.style.left=`0`,this.overlay.style.width=`100vw`,this.overlay.style.height=`100vh`,this.overlay.style.backgroundColor=`rgba(0,0,0,0.5)`,this.overlay.style.zIndex=`1000`;let e=(this.page.textBlock?.sentences||[]).map((e,t)=>`<option value="${t}" ${this.annotation.sentenceIndex===t?`selected`:``}>${t+1}: ${e.text.substring(0,30)}...</option>`).join(``);this.overlay.innerHTML=`
