const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/youtubeApi-D18DKSYl.js","assets/rolldown-runtime-lhHHWwHU.js","assets/playlists-CSQTaxpf.js","assets/db-CmEX-cIt.js","assets/pages-CIjfpH2s.js","assets/subsections-Di0IZIlv.js"])))=>i.map(i=>d[i]);
import{t as e}from"./db-CmEX-cIt.js";import{n as t}from"./subsections-Di0IZIlv.js";import{a as n,n as r,t as i}from"./pages-CIjfpH2s.js";import{n as a,t as o}from"./index-CN19KrK4.js";import{t as s}from"./tts-BXSX4OoT.js";import{getPlaylist as c,savePlaylist as l}from"./playlists-CSQTaxpf.js";import{n as u,t as d}from"./youtubeApi-D18DKSYl.js";async function f(t){let n=await e();return t.updatedAt=new Date().toISOString(),await n.put(`watch_progress`,t),t}async function p(t){return await(await e()).get(`watch_progress`,t)||{notebookId:t,updatedAt:new Date().toISOString(),videos:{}}}var m=class{constructor(e,t,n){this.container=e,this.onComplete=t,this.onSkip=n}render(){this.container.innerHTML=`
    ...
    `;let e=this.container.querySelector(`#yt-btn-mark-complete`);e&&e.addEventListener(`click`,()=>{this.onMarkComplete&&this.onMarkComplete(!this.isComplete)})}formatDuration(e){let t=Math.floor(e/3600),n=Math.floor(e%3600/60),r=e%60;return t>0?`${t}:${n.toString().padStart(2,`0`)}:${r.toString().padStart(2,`0`)}`:`${n}:${r.toString().padStart(2,`0`)}`}},w=class{constructor(e,t){this.container=e,this.onClick=t}render(){this.container.innerHTML=`
      <div id="yt-capture-icon" class="yt-overlay-icon" title="Capture a note for this video (C)">
        <i class="ti ti-clipboard-plus"></i>
      </div>
    `;let e=this.container.querySelector(`#yt-capture-icon`);e&&e.addEventListener(`click`,()=>{this.onClick&&this.onClick()})}},T=class{constructor(e,t,n,r,i,a,o){this.container=e,this.deckId=t,this.videoTitle=n,this.videoId=r,this.currentSeconds=i,this.onSaveComplete=a,this.onClose=o,this.images=[],this.targetSectionId=null,this.targetSubsectionId=null,this.targetLabel=`Select Location`}async initLocation(){this.sections=await a(this.deckId),this.subsections=await t(this.deckId);let e=localStorage.getItem(`studycanvas_last_subsection`),n=null;if(e&&(n=this.subsections.find(t=>t.subsectionId===e)),!n&&this.subsections.length>0&&(n=this.subsections[0]),n){this.targetSubsectionId=n.subsectionId,this.targetSectionId=n.sectionId;let e=this.sections.find(e=>e.sectionId===n.sectionId);this.targetLabel=(e?e.title+` / `:``)+n.title}let r=this.container.querySelector(`#yt-capture-location`);r&&(r.innerHTML=`<i class="ti ti-folder"></i> ${this.targetLabel}`)}formatTimestamp(e){let t=Math.floor(e/3600),n=Math.floor(e%3600/60),r=Math.floor(e%60);return t>0?`${t}:${n.toString().padStart(2,`0`)}:${r.toString().padStart(2,`0`)}`:`${n}:${r.toString().padStart(2,`0`)}`}render(){let e=this.formatTimestamp(this.currentSeconds),t=`${this.videoTitle} @ ${e}`;this.container.innerHTML=`
    ...
    `,requestAnimationFrame(()=>{this.container.style.width=`450px`}),this.attachEvents(),this.initLocation(),this.container.querySelector(`#yt-capture-editor`).focus()}attachEvents(){let e=this.container.querySelector(`#yt-capture-close`),t=this.container.querySelector(`#yt-capture-btn-discard`),n=this.container.querySelector(`#yt-capture-btn-save`),r=this.container.querySelector(`#yt-capture-dropzone`),i=this.container.querySelector(`#yt-capture-file-input`),a=this.container.querySelector(`#yt-capture-editor`),s=()=>{this.container.style.width=`0`,setTimeout(()=>{this.onClose&&this.onClose()},300)};e.addEventListener(`click`,s),t.addEventListener(`click`,s),n.addEventListener(`click`,()=>this.handleSave());let c=this.container.querySelector(`#yt-capture-location`);c.addEventListener(`click`,()=>{o(async()=>{let{LocationPicker:e}=await import(`./LocationPicker-BtBvmlx6.js`);return{LocationPicker:e}},[]).then(({LocationPicker:e})=>{new e(c,this.sections,this.subsections,this.targetSubsectionId,(e,t)=>{this.targetSectionId=e,this.targetSubsectionId=t;let n=this.sections.find(t=>t.sectionId===e),r=this.subsections.find(e=>e.subsectionId===t);this.targetLabel=(n?n.title+` / `:``)+(r?r.title:``),c.innerHTML=`<i class="ti ti-folder"></i> ${this.targetLabel}`},()=>{alert(`To create a new section, please use the Left Panel.`)}).render()})}),r.addEventListener(`click`,()=>i.click()),i.addEventListener(`change`,e=>this.handleFiles(e.target.files)),r.addEventListener(`dragover`,e=>{e.preventDefault(),r.style.borderColor=`var(--primary)`}),r.addEventListener(`dragleave`,()=>{r.style.borderColor=`var(--border-default)`}),r.addEventListener(`drop`,e=>{e.preventDefault(),r.style.borderColor=`var(--border-default)`,e.dataTransfer.files&&this.handleFiles(e.dataTransfer.files)}),a.addEventListener(`paste`,e=>{let t=(e.clipboardData||e.originalEvent.clipboardData).items,n=!1;for(let r of t)if(r.type.indexOf(`image`)===0){let t=r.getAsFile();this.handleFiles([t]),n=!0,e.preventDefault()}if(!n){e.preventDefault();let t=e.clipboardData.getData(`text/plain`);document.execCommand(`insertText`,!1,t)}}),this.keydownHandler=e=>{e.key===`Escape`?s():e.key===`Enter`&&(e.ctrlKey||e.metaKey)&&this.handleSave()},document.addEventListener(`keydown`,this.keydownHandler)}handleFiles(e){if(e)for(let t of e){if(this.images.length>=5)break;t.type.startsWith(`image/`)&&(this.images.push(t),this.renderImageList())}}renderImageList(){let e=this.container.querySelector(`#yt-capture-image-list`),t=this.container.querySelector(`#yt-capture-dropzone`);e.innerHTML=``,this.images.forEach((t,n)=>{let r=URL.createObjectURL(t),i=document.createElement(`div`);i.style.position=`relative`,i.style.width=`100%`,i.style.height=`120px`,i.style.borderRadius=`4px`,i.style.overflow=`hidden`,i.style.border=`1px solid var(--border-default)`,i.innerHTML=`
      ...
      `,i.querySelector(`button`).addEventListener(`click`,()=>{this.images.splice(n,1),this.renderImageList()}),e.appendChild(i)}),this.images.length>=5?t.style.display=`none`:t.style.display=`block`}async handleSave(){let t=this.container.querySelector(`#yt-capture-title`).value.trim()||`Untitled Capture`;this.container.querySelector(`#yt-capture-topic`).value.trim();let r=this.container.querySelector(`#yt-capture-source`).value,a=this.container.querySelector(`#yt-capture-resume`).checked,o=this.container.querySelector(`#yt-capture-editor`).innerText||``;if(this.images.length===0&&!o.trim()){alert(`Add at least an image or some text before saving.`);return}let s=this.container.querySelector(`#yt-capture-btn-save`);s.disabled=!0,s.innerHTML=`Saving...`;try{if(!this.targetSectionId||!this.targetSubsectionId){alert(`Please select a valid section and subsection.`),s.disabled=!1,s.innerHTML=`<i class="ti ti-device-floppy"></i> Save as Page`;return}let c=await i(this.deckId,this.targetSectionId,this.targetSubsectionId,t);c.captureSource=`youtube_capture`,c.videoTimestamp={videoId:this.videoId,seconds:this.currentSeconds,formatted:this.formatTimestamp(this.currentSeconds),videoTitle:this.videoTitle},c.textBlock.rawText=o,c.textBlock.source=r;let l=await e();for(let e of this.images){let t={storageKey:crypto.randomUUID(),blob:e,type:e.type,name:e.name||`capture.png`};await l.put(`images`,t),c.images.push({storageKey:t.storageKey,name:t.name})}await n(c),document.removeEventListener(`keydown`,this.keydownHandler),this.container.querySelector(`#yt-capture-overlay`).classList.remove(`open`),setTimeout(()=>{this.onSaveComplete&&this.onSaveComplete(c,a)},300)}catch(e){console.error(e),alert(`Failed to save capture.`),s.disabled=!1,s.innerHTML=`<i class="ti ti-device-floppy"></i> Save as Page`}}},E=class{constructor(e,t,n,r){this.container=e,this.onClick=t,this.onHoverStart=n,this.onHoverEnd=r,this.isActive=!1}setActive(e){this.isActive=e;let t=this.container.querySelector(`i`),n=this.container.querySelector(`.yt-overlay-icon`);t&&n&&(e?(t.className=`ti ti-microphone`,n.style.borderColor=`var(--watch-complete-color)`,n.style.color=`var(--watch-complete-color)`,n.style.boxShadow=`0 0 12px rgba(29,158,117,0.4)`):(t.className=`ti ti-microphone`,n.style.borderColor=``,n.style.color=``,n.style.boxShadow=``))}render(){this.container.innerHTML=`
    ...
    `;let e=this.container.querySelector(`#yt-tts-mic-icon`);e&&(e.addEventListener(`click`,()=>{this.onClick&&this.onClick()}),e.addEventListener(`mouseenter`,()=>{this.onHoverStart&&this.onHoverStart()}),e.addEventListener(`mouseleave`,()=>{this.onHoverEnd&&this.onHoverEnd()}))}},D=class{constructor(e,t,n){this.container=e,this.page=t,this.onPlay=n}render(){if(!this.page){this.container.innerHTML=``;return}let e=this.page.textBlock?.rawText||``;e.length>80&&(e=e.substring(0,80)+`...`),this.container.innerHTML=`
